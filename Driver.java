...
public class Driver {
	public static void main(String[] args) {
		...
		int[] argument1 = new int[]{9, 20, 3, 44, 88, 300};
		int[] result1 = ArrayUtils.reverse(argument1); //reversing
		String stringifiedResult1 = ArrayUtils.stringifyArray(result1); //stringifying
